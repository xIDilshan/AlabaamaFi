...
export default function Home() {
  ...
  className={`max-w-[110px] truncate rounded-full px-2.5 py-2 text-[10px] !font-black tracking-tight sm:max-w-none sm:px-5 sm:py-3 sm:text-xs lg:text-sm ${connectGlassButton}`}
>
