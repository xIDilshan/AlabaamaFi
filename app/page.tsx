                ...
                <div className="mx-auto max-w-5xl">
                  ...
                  <div className="mt-9 flex flex-col justify-center gap-3 sm:mt-10 sm:flex-row">
                    <button
                      ...
                      className="min-h-13 w-full rounded-2xl border border-white/[0.12] bg-white/[0.94] px-7 py-4 text-sm !font-bold tracking-tight text-black shadow-xl shadow-black/40 transition-all duration-200 hover:-translate-y-0.5 hover:bg-white hover:shadow-2xl hover:shadow-black/50 active:translate-y-0 sm:w-auto"
                    >
                      Send Assets
                    </button>
