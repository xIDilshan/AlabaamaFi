...
export default function Home() {
  ...
  className={`max-w-[80px] truncate rounded-full px-2 py-1.5 text-[5px] !font-black tracking-tight sm:max-w-none sm:px-5 sm:py-3 sm:text-xs lg:text-sm ${connectGlassButton}`}
>
