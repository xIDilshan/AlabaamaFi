...
if (  
  ...
  try {  
    ...
    try {  
      ...
      /*  
       * Token API failure should not  
       * prevent transaction history  
       * from loading.  
       */  
    }  
    ...
    /*  
     * Remove USDC returned by  
     * Arcscan and use the direct  
     * RPC balance instead.  
     */  
    ...
    let hasPortfolioValue =  
      false;  

    for (  
      const token of holdings  
    ) {  
      if (  
        token.usdValue !==  
          null &&  
                  ...
                  (tx) => (  
                    ...
                    >  
                      ...
                      <a  
                        ...
                        target="_blank"  
                        rel="noopener noreferrer"  
                        className="mt-4 block border-t border-white/10 pt-3 text-xs text-white/40 transition hover:text-white"  
                      >  
                        View on Arc Explorer →  
                      </a>  
