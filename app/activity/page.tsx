...
<div className="min-w-0">
  ...
  <div className="mt-1 flex min-w-0 items-start gap-2">
    <p className="min-w-0 flex-1 whitespace-normal break-all font-mono text-xs font-medium leading-5 text-white/25">
    ...
    <button
      ...
      className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-white/[0.06] bg-white/[0.03] text-white/40 transition hover:bg-white/[0.07] hover:text-white/70"
    >
      {copiedHash ===
      tx.hash ? (
        <svg
