        ...
        <div className="grid gap-3">
          ...
          <div className="rounded-2xl border border-white/[0.07] bg-[#020202] p-4 sm:p-5">
            ...
            <div className="mt-3 flex min-h-[60px] items-center gap-3">
              ...
              <input
                ...
                className="min-w-0 flex-1 truncate appearance-none bg-transparent p-0 text-white/70 outline-none placeholder:text-white/15 sm:text-[2.25rem] sm:leading-[2.5rem]"
              />
          ...
          <div className="rounded-2xl border border-white/[0.07] bg-[#020202] p-4 sm:p-5">
            ...
            <div className="mt-3 flex min-h-[60px] items-center gap-3">
              ...
              <span className="min-w-0 flex-1 truncate text-3xl font-black tracking-tight leading-normal text-white/70 sm:text-4xl">
                {isLoading
                  ? "..."
                  : estimatedOutput ||
                    (amountIn
