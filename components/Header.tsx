          ...
          <div className="mx-auto grid min-h-[72px] max-w-[1600px] grid-cols-[1fr_auto_1fr] items-center gap-3 px-4 sm:px-6">
            ...
            <div className="flex min-w-0 items-center justify-end">
              <button
                ...
                className={`flex max-w-[135px] items-center gap-1 truncate rounded-full px-2 py-1.5 text-[11px] !font-black tracking-tight sm:max-w-none sm:gap-2 sm:px-5 sm:py-3 sm:text-xs ${connectGlassButton}`}
              >
